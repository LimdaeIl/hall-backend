...
public class PaymentService {
    ...
    @Transactional
    public Payment pay(Long memberId, Long reservationId, PaymentMethod method) {
        validatePaymentMethod(method);

        /*
         * 동일 예약 결제, 취소, 만료 요청을 직렬화합니다.
         */
        Reservation reservation = reservationRepository.findByIdForPayment(reservationId)
                .orElseThrow(
