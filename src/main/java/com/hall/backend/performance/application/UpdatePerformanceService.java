...
public class UpdatePerformanceService {
    ...
    @Transactional
    public UpdatePerformanceResponse update(
            Long performanceId,
        ...
        return UpdatePerformanceResponse.from(
                performance
        );
    }

    private void validateDuplicatedStartsAt(
            Performance performance,
        ...
        boolean duplicated =
                performanceRepository
                        .existsByConcertIdAndStartsAtAndIdNot(
