...
public class CreatePerformanceSeatsService {
    ...
    @Transactional
    public CreatePerformanceSeatsResponse create(
            Long performanceId,
        ...
        validatePerformanceSeatsNotCreated(
                performanceId
        );
        ...
        List<PerformanceSeat> savedPerformanceSeats =
                performanceSeatRepository.saveAllAndFlush(
                        performanceSeats
                );

        return CreatePerformanceSeatsResponse.of(
                performance,
                savedPerformanceSeats
        );
    }

    private void validatePerformanceSeatsNotCreated(
            Long performanceId
    ) {
        ...
        if (alreadyExists) {
            throw new PerformanceException(
                    PerformanceErrorCode
                            .PERFORMANCE_SEATS_ALREADY_EXIST
            );
        }
    }
